...
void main() {
    ...
    texture2D(u_tex, v_uv + vec2(onePixel.x, onePixel.y)) +
    texture2D(u_tex, v_uv + vec2(-onePixel.x, -onePixel.y)) +
    texture2D(u_tex, v_uv + vec2(-onePixel.x, onePixel.y)) +
    texture2D(u_tex, v_uv + vec2(onePixel.x, -onePixel.y)) +

    texture2D(u_tex, v_uv + vec2(onePixel.x+onePixel.x, onePixel.y+onePixel.y)) +
    texture2D(u_tex, v_uv + vec2(-onePixel.x-onePixel.x, -onePixel.y-onePixel.y)) +
    texture2D(u_tex, v_uv + vec2(-onePixel.x-onePixel.x, onePixel.y+onePixel.y)) +
    texture2D(u_tex, v_uv + vec2(onePixel.x+onePixel.x, -onePixel.y-onePixel.y)) +
    ...
    texture2D(u_tex, v_uv + vec2(onePixel.x+onePixel.x+onePixel.x, 0.0)) +
    texture2D(u_tex, v_uv + vec2(-onePixel.x-onePixel.x-onePixel.x  , 0.0)) +
    texture2D(u_tex, v_uv + vec2(0.0, onePixel.y+onePixel.y+onePixel.y )) +
    texture2D(u_tex, v_uv + vec2(0.0, -onePixel.y-onePixel.y-onePixel.y ))
